...
public class AllAnimalBasicData extends SimpleSynchronousServiceServlet {
        ...
        try {
            ...
            if (status == HttpURLConnection.HTTP_OK) {
                ...
                while (elementIterator.hasNext()) {
                    ...
                    Resource animalRes = outputModel.createResource();
                    animalRes.addProperty(Vocab.has_AnimalBasicDataId, idVal);
                    animalRes.addProperty(Vocab.type,output);
                }
    ...
    public static final class Vocab {
        ...
        public static final Resource Animal = m_model.createResource("http://localhost:8080/ontology/domain-ontology/nwf.owl#Animal");
